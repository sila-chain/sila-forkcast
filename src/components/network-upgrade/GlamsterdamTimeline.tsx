        ...
        <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-600">
          <div className="flex items-start justify-between">
            <a
              ...
              onClick={() => handleExternalLinkClick('timeline_discussion', 'https://sila-magicians.org/t/sip-7773-glamsterdam-network-upgrade-meta-thread/21195')}
            ...
            >
              View full timeline details on Sila Magicians
