      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            Sila's public networks, plus the devnets run by the <a href="https://ethpandaops.io/" target="_blank" rel="noopener noreferrer" className="text-purple-600 dark:text-purple-400 hover:underline">ethPandaOps</a> team.
          </p>
        </div>
