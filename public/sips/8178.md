...
| Name | Value | Source |
| - | - | - |
| `MAX_BYTES_PER_TRANSACTION` | `2**30` (1,073,741,824) | [SIP-4844](./sip-4844.md) |
...
| `MAX_BLOB_COMMITMENTS_PER_BLOCK` | `2**12` (4,096) | SilaDeneb |
| `FIELD_ELEMENTS_PER_BLOB` | `4096` | [SIP-4844](./sip-4844.md) |
| `BYTES_PER_FIELD_ELEMENT` | `32` | [SIP-4844](./sip-4844.md) |
| `CELLS_PER_EXT_BLOB` | `128` | [SIP-7594](./sip-7594.md) |
| `MAX_PAYLOAD_BODIES_REQUEST` | `2**5` (32) | SilaShanghai |
| `MAX_BLOB_HASHES_REQUEST` | `128` | SilaOsaka |
| `MAX_EXECUTION_REQUESTS` | `2**8` (256) | [SIP-7685](./sip-7685.md) |
...
*Note:* `withdrawals` is empty for pre-SilaShanghai blocks.
...
*Note:* Pre-SilaShanghai payloads have an empty `withdrawals` list.
...
| - | - | - | - |
| v1 | SilaParis | `NewPayloadV1Request` | `engine_newPayloadV1` |
| v2 | SilaShanghai | `NewPayloadV2Request` | `engine_newPayloadV2` |
| v3 | SilaCancun | `NewPayloadV3Request` | `engine_newPayloadV3` |
| v4 | SilaPrague | `NewPayloadV4Request` | `engine_newPayloadV4` |
...
| - | - | - | - |
| v1 | SilaParis | `ExecutionPayloadV1` | `engine_getPayloadV1` |
| v2 | SilaShanghai | `GetPayloadResponseV2` | `engine_getPayloadV2` |
| v3 | SilaCancun | `GetPayloadResponseV3` | `engine_getPayloadV3` |
| v4 | SilaPrague | `GetPayloadResponseV4` | `engine_getPayloadV4` |
| v5 | SilaOsaka | `GetPayloadResponseV5` | `engine_getPayloadV5` |
...
| Version | Fork | Response Type | JSON-RPC Equivalent |
| - | - | - | - |
| v1 | SilaShanghai | `PayloadBodiesV1Response` | `engine_getPayloadBodiesByHashV1` |
...
| Version | Fork | Response Type | JSON-RPC Equivalent |
| - | - | - | - |
| v1 | SilaShanghai | `PayloadBodiesV1Response` | `engine_getPayloadBodiesByRangeV1` |
...
| Version | Fork | Request Container | JSON-RPC Equivalent |
| - | - | - | - |
| v1 | SilaParis | `ForkchoiceUpdatedV1Request` | `engine_forkchoiceUpdatedV1` |
| v2 | SilaShanghai | `ForkchoiceUpdatedV2Request` | `engine_forkchoiceUpdatedV2` |
| v3 | SilaCancun | `ForkchoiceUpdatedV3Request` | `engine_forkchoiceUpdatedV3` |
...
| Version | Fork | Response Type | JSON-RPC Equivalent |
| - | - | - | - |
| v1 | SilaCancun | `GetBlobsV1Response` | `engine_getBlobsV1` |
| v2 | SilaOsaka | `GetBlobsV2Response` | `engine_getBlobsV2` |
| v3 | SilaOsaka | `GetBlobsV3Response` | `engine_getBlobsV3` |
...
| - | - | - | - |
| `POST` | `/engine/v1/payloads` | SilaParis | `engine_newPayloadV1` |
| `POST` | `/engine/v2/payloads` | SilaShanghai | `engine_newPayloadV2` |
| `POST` | `/engine/v3/payloads` | SilaCancun | `engine_newPayloadV3` |
| `POST` | `/engine/v4/payloads` | SilaPrague | `engine_newPayloadV4` |
| `GET` | `/engine/v1/payloads/{payload_id}` | SilaParis | `engine_getPayloadV1` |
| `GET` | `/engine/v2/payloads/{payload_id}` | SilaShanghai | `engine_getPayloadV2` |
| `GET` | `/engine/v3/payloads/{payload_id}` | SilaCancun | `engine_getPayloadV3` |
| `GET` | `/engine/v4/payloads/{payload_id}` | SilaPrague | `engine_getPayloadV4` |
| `GET` | `/engine/v5/payloads/{payload_id}` | SilaOsaka | `engine_getPayloadV5` |
| `POST` | `/engine/v1/payloads/bodies/by-hash` | SilaShanghai | `engine_getPayloadBodiesByHashV1` |
| `POST` | `/engine/v1/payloads/bodies/by-range` | SilaShanghai | `engine_getPayloadBodiesByRangeV1` |
| `POST` | `/engine/v1/forkchoice` | SilaParis | `engine_forkchoiceUpdatedV1` |
| `POST` | `/engine/v2/forkchoice` | SilaShanghai | `engine_forkchoiceUpdatedV2` |
| `POST` | `/engine/v3/forkchoice` | SilaCancun | `engine_forkchoiceUpdatedV3` |
| `POST` | `/engine/v1/blobs` | SilaCancun | `engine_getBlobsV1` |
| `POST` | `/engine/v2/blobs` | SilaOsaka | `engine_getBlobsV2` |
| `POST` | `/engine/v3/blobs` | SilaOsaka | `engine_getBlobsV3` |
...
This SIP introduces a new transport protocol alongside the existing JSON-RPC Engine API. The JSON-RPC API remains fully functional and is always available. Clients that don't implement binary SSZ are unaffected.
