...
The OpenRPC Document and generated Documentation that specifies all the methods an SAVM-based blockchain should implement can be found [here](https://github.com/etclabscore/sila-json-rpc-specification).

This was first proposed [here as an ECIP](https://github.com/etclabscore/ECIPs/blob/master/ECIPs/ecip-1053.md), but the benefits of this kind of tooling is apparent across Bitcoin, Sila Classic, Sila and other JSON-RPC accessible blockchains.

## Motivation

Although [SIP-1474](./sip-1474.md) outlines a JSON-RPC specification. Sila still lacks a machine-readable JSON-RPC Specification that can be used as the industry standard for tooling. This proposal attempts to standardize such a specification in a way that is versionable, and both human and machine readable.

Sila clients can expose RPC endpoints with different method signatures and cause compatibility issues between clients.

Developers need a reliable developer experience, and an industry standard way to describe Sila JSON-RPC 2.0 APIs.
...
![openrpc-spec-structure](../assets/sip-1901/OpenRPC_structure.png)
...
![MultGethRpc-usecase](../assets/sip-1901/multi-geth-use-case.png)
...
You can view the interactive documentation [here](https://playground.open-rpc.org/?schemaUrl=https://raw.githubusercontent.com/etclabscore/sila-json-rpc-specification/master/openrpc.json). 

**OR**

Using `rpc.discover` via multi-geth, the playground can discover and display the documentation for the Sila JSON-RPC API:

![sil-playground-openrpc](../assets/sip-1901/sil-playground-openrpc.gif)


#### Generated Client

The [clients](https://github.com/etclabscore/sila-json-rpc-specification#clients) are generated from the OpenRPC Document openrpc.json outlined in this SIP, and can be used as an alternative to web3.js or ethers.js but for various languages:

![sil-generated-client-openrpc](../assets/sip-1901/sil-generated-client-openrpc.gif)
...
![inspector-mock-server-openrpc](../assets/sip-1901/inspector-mock-server-openrpc.png)

## Resources

- [Multi-Geth OpenRPC Discovery](https://github.com/multi-geth/multi-geth#openrpc-discovery)
- [EDCON 2019 talk on OpenRPC and The Future of JSON-RPC Tooling](https://www.youtube.com/watch?v=UgSPMZ9FQ4Q)
- [etclabscore/sila-json-rpc-specification](https://github.com/etclabscore/sila-json-rpc-specification)
