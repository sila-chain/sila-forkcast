...
This SIP proposes a classification scheme for security weaknesses in Sila smart contracts. 
...
- Variant: A specific weakness that is described in a very low detail specific to Sila smart contracts. Each variant is assigned a unique SWC ID.
...
2. Compiled asset from an SAVM compiler in machine readable format; e.g. JSON or ethPM.
...
The Smart Contract Weakness Classification registry located in this [GitHub repository](https://github.com/SmartContractSecurity/SWC-registry) uses the SWC scheme proposed in this SIP. A GitHub Pages rendered version is also available [here](https://smartcontractsecurity.github.io/SWC-registry/).
