...
Rewriting storage does not affect state growth, which is the main issue this SIP is addressing. Rewriting storage may also be underpriced.
...
https://github.com/sila-chain/go-sila/pull/24725
