...
This document proposes to improve the uniformity of sila distribution
...
or uniform, with the former having more than 365,000 sila
more than the latter. The distribution of sila between these two
...
100,000 sila from the former address to the latter. This is a properly
...
the owner of an address which does not own an equitable amount of sila
to claim their share of sila from an address which owns a dangerously
centralized quantity. Rather than proposing an overly complicated generic
mechanism for any user to claim sila to which they believe they are
equitably entitled, this proposal will take the simple route of a one-time
transfer of 100,000 sila from `0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B`
...
by 100,000 sila. The balance of `0x15E55EF43efA8348dDaeAa455F16C43B64917e3c`
will be increased by 100,000 sila. No net change in the amount of extant
sila will occur unless at the time of implementation the former address does not
contain sufficient sila for such a deduction.
...
determine the optimal distribution of sila between these addresses.
