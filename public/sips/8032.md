...
Transition reference: [SIP-7612](./sip-7612.md)
...
### Compatibility with SIP-2926

Because [SIP-2926](./sip-2926.md) also requires an account transition to chunkify the bytecode and additional fields, scheduling both SIPs in the same fork enables a single, combined transition. This removes duplicated work, reduces client complexity and the number of tree transitions in the future.
