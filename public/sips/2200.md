...
This is an SIP that implements net gas metering. It's a combined
version of [SIP-1283] and [SIP-1706], with a structured definition so as
to make it interoperable with other gas changes such as [SIP-1884].

## Abstract

This SIP provides a structured definition of net gas metering changes
...
This is a combination of [SIP-1283] and [SIP-1706].

## Motivation

This SIP proposes a way for gas metering on `SSTORE`, using information
...
The original definition of SIP-1283 created a danger of a new kind of
...
This SIP also replaces the original SIP-1283 value definitions of gas
...
Change the definition of SIP-1283 using those variables. The new
specification, combining SIP-1283 and SIP-1706, will look like
...
Examine examples provided in SIP-1087's Motivation (with `SLOAD_GAS` being
`200`):
...
* Add contract metadata specifying per-contract SAVM version, and only
...
it does not introduce incompatibility to the Sila SilaMainnet. Gas
...
[SIP-1283]: ./sip-1283.md
[SIP-1706]: ./sip-1706.md
[SIP-1884]: ./sip-1884.md
[SIP-1087]: ./sip-1087.md
[SIP-1153]: ./sip-1153.md
[SIP-658]: ./sip-658.md