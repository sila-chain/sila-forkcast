...
We propose splitting the Sila transaction scope into multiple steps: validations, execution, and post-operation logic. Transaction validity is determined by the result of the validation steps of a transaction.
...
A more detailed motivation for this proposal can be found in the [README document](../assets/sip-7701/README.md).
...
A new [SIP-2718](./sip-2718) transaction with type `AA_TX_TYPE` is introduced.
...
an additional [SIP-2930](./sip-2930) `ACCESS_LIST_ADDRESS_COST` cost of **2400 gas** is charged and the address is added to `accessed_addresses`.
...
A full list of rationales for the decisions made in this proposal can be found in the [README document](../assets/sip-7701/README.md).
...
We expect that compilers targeting SAVM will play a major role in enabling and ensuring Smart Contract Accounts' security.
