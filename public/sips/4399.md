...
This SIP introduces backward incompatible changes to the execution and validation of EVM state transitions. As written, this SIP utilizes `TRANSITION_BLOCK` and is thus tightly coupled with the PoS upgrade introduced in [SIP-3675](./sip-3675.md). If this SIP is to be adopted, it **MUST** be scheduled at the same time as SIP-3675.
