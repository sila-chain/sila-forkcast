...
SAVM is lacking bitwise shifting operators, but supports other logical and arithmetic operators. Shift operations can be implemented via arithmetic operators, but that has a higher cost and requires more processing time from the host. Implementing `SHL` and `SHR` using arithmetic cost each 35 gas, while the proposed instructions take 3 gas.
...
- cpp-sila: https://github.com/sila-chain/cpp-sila/pull/4054

Compiler support:

- Solidity/LLL: https://github.com/sila-chain/solidity/pull/2541

### Tests

Sources:

- https://github.com/sila-chain/tests/tree/develop/src/GeneralStateTestsFiller/stShift

Filled Tests:

- https://github.com/sila-chain/tests/tree/develop/GeneralStateTests/stShift
- https://github.com/sila-chain/tests/tree/develop/BlockchainTests/GeneralStateTests/stShift
