...
Introduce a new [SIP-2718 transaction type](./sip-2718.md) to support validator withdrawals that are "pushed" from the beacon chain to the EVM.
...
This SIP provides a way for validator withdrawals made on the beacon chain to enter into the EVM.
...
This SIP suggests a new transaction type as it has special semantics different from other existing types of EVM transactions.
...
This consensus-layer to execution-layer SIL transfer does not have a current analog in the EVM and thus deserves very high security scrutiny.
