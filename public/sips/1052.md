## Abstract
This SIP specifies a new opcode, which returns the keccak256 hash of a contract's code.
...
In case the account does not exist or is empty (as defined by [SIP-161](./sip-161.md)) `0` is pushed to the stack.
