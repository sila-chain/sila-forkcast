...
This proposal specifies hardware and bandwidth recommendations for different types of Sila nodes:
...
- **Capacity Considerations**  
  ...
  - While SIP-4444 aims to reduce historical storage requirements, the timeline for SIP-4444 remains uncertain.

### Memory

- **Why 64 GB for Validators (Attesters / Local Block Builders)?**
  - Running an Sila validator (both EL & CL clients) can be memory-intensive, with state cache dominating RAM usage.
...
This SIP is informational and requires no protocol changes. We recommend that future SIPs include an assessment of their impact on these hardware recommendations.
