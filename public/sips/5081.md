## Abstract
This SIP adds a new transaction type of that includes expiration with a blocknum.
...
- `FORK_BLKNUM` = `TBD`
- `CHAIN_ID` = `TBD`
- `TX_TYPE` = TBD, > 0x02 ([SIP-1559](./sip-1559.md))
...
The definitions of all other fields share the same meaning with [SIP-1559](./sip-1559.md)
