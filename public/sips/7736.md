...
At the start of the validation, charge the costs using constants defined in [SIP-4762](./sip-4762.md):
 ...
 * Increasing the cost of a read to that of a write. This would increase the gas costs even more than they did in SIP-4762.
 * Effectively doing a write for the cost of a read. This would both neuter state expiry and possibly add a DOS vector.

## Backwards Compatibility

This proposal is backwards-compatible with verkle, as by default the value for the 4th (index starting at 0) evaluation point is set to `0` in [SIP-6800](./sip-6800.md), which is the value of `INITIAL_EPOCH_COUNTER`.
