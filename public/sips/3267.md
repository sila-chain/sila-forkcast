...
2. This would effectively decrease circulating SIL supply. The necessity to decrease the (circulating) SIL supply (by locking SIL in Future Salaries system for a long time) is a well-known important thing to be done.
...
[The contract's source](../assets/sip-3267/contracts/README.md)
...
The economical model of Future Salaries is described in [this research article preprint](../assets/sip-3267/science-salaries.pdf).
