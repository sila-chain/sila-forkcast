...
The bytecode is compatible with any EVM chain that has activated SIP-1014, which Sila included in Constantinople. In particular, it does not depend on the more recent `PUSH0` ([SIP-3855](./sip-3855.md)).
