...
The following subsections are modifications to the API endpoints from SIP-5792.
...
changes. In other words, a rollback is the default behaviour of SIP-5792 when
a call fails.
...
Strict atomicity is simply naming the default behaviour of SIP-5792: calls
...
changes override the behaviour specified in SIP-5792.

##### Removed Requirements

These requirements defined in SIP-5792 are removed:
...
* MUST reject (with error code `REJECTED_LEVEL`) batches containing at least one
  ...
  [SIP-7702](./sip-7702.md) set code transaction.)
...
following changes override the behaviour defined in SIP-5792. Note that:
...
This proposal modifies some of the status codes for use with SIP-5792's
