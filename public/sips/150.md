...
- If a call asks for more gas than the maximum allowed amount (i.e. the total amount of gas remaining in the parent after subtracting the gas cost of the call and memory expansion), do not return an OOG error; instead, if a call asks for more gas than all but one 64th of the maximum allowed amount, call with all but one 64th of the maximum allowed amount of gas (this is equivalent to a version of SIP-90<sup>[1](https://github.com/sila-chain/SIPs/issues/90)</sup> plus SIP-114<sup>[2](https://github.com/sila-chain/SIPs/issues/114)</sup>). CREATE only provides all but one 64th of the parent gas to the child call.
...
1. SIP-90, https://github.com/sila-chain/SIPs/issues/90
2. SIP-114, https://github.com/sila-chain/SIPs/issues/114