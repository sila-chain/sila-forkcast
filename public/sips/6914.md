...
The configuration values and mechanics of the specification can be found in the [Consensus Layer specs](https://github.com/sila-chain/consensus-specs/blob/1a38b83e5db8638ee01c9461cccf11e7d8a3ebce/specs/_features/eip6914).
...
This is a backwards incompatible change to the Consensus Layer of Sila and must be scheduled with a hard fork.
