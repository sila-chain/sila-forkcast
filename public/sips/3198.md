## Simple Summary
Adds an opcode that gives the SAVM access to the block's base fee.
...
### Gas cost
The value of the base fee is needed to process transactions. That means it's value is already available before running the SAVM code.
