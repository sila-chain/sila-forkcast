...
Cell-Level Deltas for Data Column Broadcast optimizes SilaPeerDAS ([SIP-7594](./sip-7594.md)) by
...
in the [sila/consensus-specs](https://github.com/sila-chain/consensus-specs/tree/b3b06d939c3f7301d218bca7adc39eed5806d553/./) repo.
...
1. While it is more efficient for a node to mesh with peers that support this
   SIP, it risks dividing the network if those peers are preferred.
