...
This SIP defines additional little endian opcodes that can be deployed alongside [SIP-7937](./sip-7937.md).

## Motivation

The core SIP that defines EVM64 (SIP-7937) is endianness-independent. This SIP defines those additional opcodes that must expose endianness. They are the bitwise opcode `BYTE64`, memory opcodes `MLOAD64` and `MSTORE64`, and stack opcodes `PUSH*64`.
