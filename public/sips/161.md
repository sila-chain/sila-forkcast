...
In the present Sila protocol, it should be noted that very few state changes can ultimately result in accounts that are empty following the execution of the transaction. In fact there are only four contexts that current implementations need track:
...
3. https://blog.sila.org/2016/11/25/security-alert-11242016-consensus-bug-geth-v1-4-19-v1-5-2/
