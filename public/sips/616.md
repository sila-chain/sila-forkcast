...
A proposal to provide Single Instruction Multiple Data types and operations for the Sila Virtual Machine, making full use of the 256-bit wide EVM stack items, and offering substantial performance gains for both vector and scalar operations.
