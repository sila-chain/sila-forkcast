...
This SIP suggests to add precompiled contracts for a pairing function on a specific pairing-friendly elliptic curve. This can in turn be combined with [SIP-196](./sip-196.md) to verify zkSNARKs in Sila smart contracts. The general benefit of zkSNARKs for Sila is that it will increase the privacy for users (because of the Zero-Knowledge property) and might also be a scalability solution (because of the succinctness and efficient verifiability property).
...
Implementations are available here:
 ...
 - [Python](https://github.com/sila-chain/py_pairing/blob/master/py_ecc/bn128/bn128_pairing.py)
