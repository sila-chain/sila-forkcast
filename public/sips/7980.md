...
This SIP adds a new [SIP-7932](./sip-7932.md) algorithm of type `0x0` for supporting Ed25519 signatures.
...
cases against during the implementation phase of [SIP-7932](./sip-7932.md).
...
This allows it to be an algorithm for client teams to easily test [SIP-7932](./sip-7932.md).

It may also be useful for signing in Hardware security modules in server environments designed for serving
as [SRC-4337](./sip-4337.md) bundlers. It may also improve interoperability with other components such as TPM chips.
