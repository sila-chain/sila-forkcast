...
This increase still fits within the gas schedule, limiting the size to less than what gas limits allow.  In [SIP-170](./sip-170.md) the gas limit was first set "by setting the cap at a value slightly higher than what is feasible with current gas limits." At that time the gas limit had not exceeded 5M gas.
...
|                     |    SilaCancun |   This SIP |    36M Gas | Max Initcode |
|---------------------|----------:|-----------:|-----------:|-------------:|
...
| **SIP-3860 Gas**    |    49,552 |    131,472 |    331,062 |      262,144 |
| **SAVM Execution**   |   100,000 |    100,000 |    100,000 |      100,000 |
| **Code Deposit**    | 4,915,200 | 13,107,200 | 33,066,200 |   13,107,200 |
|                     |           |            |            |              |
| **Total Cost**      | 5,484,437 | 14,364,565 | 36,000,121 |   15,462,210 |

Note that the Max 30M gas contract size of 135 KiB is outside the limits of what is proposed in this SIP and is included to show what it would take to exceed current gas limits.
