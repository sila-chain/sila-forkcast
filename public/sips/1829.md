...
The BN254 (aka alt_bn8) multiplication operation introduced by the [SIP-196][SIP-196] precompile only handles a single scalar multiplication. The missed performance is such that for two or more points it is cheaper to use SAVM, as practically demonstrated by [Weierstrudel][ws].
...
**256-bit modulus.** This SIP is for field moduli less than `2^{256}`. This covers many of the popular curves while still having all parameters fit in a single SAVM word.
...
* [SIP-196](./sip-196.md): ecadd, ecmul for altbn128
* [SIP issue 603](https://github.com/sila-chain/SIPs/issues/603): ecadd, ecmul for SECP256k1.
* [SIP-665](./sip-665.md): ECDSA verify for ED25519.
* [SIP-1108](./sip-1108.md): Optimize ecadd and ecmul for altbn128.
