...
To remedy the situation, we'd like to introduce new RPC methods for the sila JSON-RPC. Those methods help enable wallets to implement the Silent Signing feature.
...
![](../assets/sip-5345/walletconnect-flow.png)
