...
This SIP defines an extension to Node Discovery Protocol v4 to enable authoritative
resolution of [Sila Node Records (ENR)](./sip-778.md).
...
of a node record. This SIP provides a way to request it using the existing discovery
protocol.
