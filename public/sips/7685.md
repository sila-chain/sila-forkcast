...
This SIP makes no strict requirement where a request may come from nor when/how
...
request is opaque as far as this SIP is concerned. Therefore, it is to be
