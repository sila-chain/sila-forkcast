...
- no change to the existing structure of the Sila state.
...
Only contracts deployed before [SIP-170](./sip-170.md) could possibly be longer than the current max code size, and the reference implementation was able to successfully import all blocks before that fork.

## Reference Implementation

The reference implementation on Geth is available at [0001-unlimit-code-size.patch](../assets/sip-5027/0001-unlimit-code-size.patch).
