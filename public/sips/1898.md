...
The following options, quoted from the Sila JSON-RPC spec, are currently possible for the defaultBlock parameter:
...
Since there is no way to clearly distinguish between a DATA parameter and a QUANTITY parameter, this SIP proposes a new scheme for the block parameter. The following option is additionally allowed:
...
- `"0x0"`
- `{ "blockNumber": "0x0" }`
- `{ "blockHash": "0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3" }` (hash of the genesis block on the Sila main chain)
