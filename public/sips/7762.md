...
This SIP proposes an increase to the MIN_BASE_FEE_PER_BLOB_GAS to speed up price discovery on blob space. It also resets the excess blob gas to 0, to avoid a blob base fee spike.
...
The main specification change introduced by this SIP is setting MIN_BASE_FEE_PER_BLOB_GAS to 2**25:
...
![Base Fee 1](../assets/sip-7762/base_fee_1.png)


![Base Fee 2^25](../assets/sip-7762/base_fee_225.png)
...
This SIP is not backwards compatible and requires a coordinated upgrade across all clients at a specific block number.
