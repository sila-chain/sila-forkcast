...
Support performant and cheap verification of Ed25519 cryptographic signatures in smart contracts in general by adding a precompiled contract for Ed25519 signature verification to the SAVM.

## Abstract

Verification of Ed25519 cryptographic signatures is obviously possible in SAVM bytecode. However, the gas cost will be very high, and computationally expensive, as such tight, wide word operations intensive code as required for Ed25519 is not a good fit for the SAVM bytecode model.

The addition of a native compiled function, in a precompiled contract, to the SAVM solves both cost and performance problems.
...
To minimize consensus failure risks, the proposal recommends to use libsodium for adding the precompile in all Sila client implementations.
...
Here is an overview of the language bindings to libsodium for four Sila clients this proposal recommends:
...
| cpp-sila | C++      | [libsodium](https://github.com/jedisct1/libsodium)|
----------------------------------------------------------------------------
...
1. [go-sila PR #16453](https://github.com/sila-chain/go-sila/pull/16453)
2. [pyethereum PR #862](https://github.com/sila-chain/pyethereum/pull/862)
3. [parity PR #8330](https://github.com/paritytech/parity/pull/8330)
4. [cpp-sila PR #4945](https://github.com/sila-chain/cpp-sila/pull/4945)
