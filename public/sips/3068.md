## Simple Summary
This SIP defines a hash-to-curve precompile for use in BN256
...
in the SAVM for a hash-to-curve algorithm for the BN256 elliptic curve.
...
more computation.
This SIP remedies this by implementing a hash-to-curve algorithm
...
[SIP-198](./sip-198.md) and
[SIP-1108](./sip-1108.md)
increased usage of cryptographic operations in the SAVM
by reducing the gas costs.
In particular, the cost reduction from
[SIP-1108](./sip-1108.md)
helps increase the use of SNARKs in Sila
via an elliptic curve pairing check;
however, a hash-to-curve algorithm enabling arbitrary
BLS signature verification on BN256 in the SAVM was noticeably missing.
There is interest in having a precompiled contract which would allow
for signature verification, as noted
[here](https://sila-magicians.org/t/pre-compile-for-bls/3973).
...
a distributed key generation protocol in Sila,
less expensive.
...
[paper](../assets/sip-3068/latincrypt12.pdf)
with modifications based on Wahby and Boneh's
[paper](../assets/sip-3068/2019-403_BLS12_H2C.pdf).
...
[here](../assets/sip-3068/2012-685_Square_Root_Even_Ext.pdf).
...
Due to recent [work](../assets/sip-3068/2015-1027_exTNFS.pdf), the
...
[two](../assets/sip-3068/2016-1102_Assessing_NFS_Advances.pdf)
[papers](../assets/sip-3068/2017-334.pdf)
...
[whitepaper](../assets/sip-3068/madnet.pdf),
...
Full disclosure: the author of this SIP works for MadHive,
...
they are independent of this SIP.
