...
This SIP defines a migration process of [SIP-2718](./sip-2718.md) Recursive-Length Prefix (RLP) transactions to [Simple Serialize (SSZ)](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/ssz/simple-serialize.md).
...
This SIP addresses these by defining a lossless conversion mechanism to normalize transaction representation across both Consensus Layer and Execution Layer while retaining support for processing RLP transaction types.
...
| Name | Value |
| - | - |
| [`BYTES_PER_FIELD_ELEMENT`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/polynomial-commitments.md#constants) | `uint64(32)` |
| [`FIELD_ELEMENTS_PER_BLOB`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/polynomial-commitments.md#blob) | `uint64(4096)` |

| Name | SSZ equivalent |
| - | - |
| [`Hash32`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/phase0/beacon-chain.md#custom-types) | `Bytes32` |
| [`ExecutionAddress`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/bellatrix/beacon-chain.md#custom-types) | `Bytes20` |
| [`VersionedHash`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/beacon-chain.md#custom-types) | `Bytes32` |
| [`KZGCommitment`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/polynomial-commitments.md#custom-types) | `Bytes48` |
| [`KZGProof`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/polynomial-commitments.md#custom-types) | `Bytes48` |
| [`Blob`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/polynomial-commitments.md#custom-types) | `ByteVector[BYTES_PER_FIELD_ELEMENT * FIELD_ELEMENTS_PER_BLOB]` |
...
| - | - | - |
| `SECP256K1_ALGORITHM` | `uint8(0x00)` | Defined from [SIP-7932](./sip-7932.md) |

#### Verification

The following functions are imported from [SIP-7932](./sip-7932.md):
...
| Name | SSZ equivalent | Description |
| - | - | - |
| `TransactionType` | `uint8` | [SIP-2718](./sip-2718.md) transaction type, range `[0x00, 0x7F]` |
| `ChainId` | `uint256` | [SIP-155](./sip-155.md) chain ID |
...
#### SIP-155 legacy transactions

These transactions are locked to a single [SIP-155](./sip-155.md) chain ID.
...
These transactions support specifying an [SIP-2930](./sip-2930.md) access list.
...
#### SIP-1559 fee market transactions

These transactions support specifying [SIP-1559](./sip-1559.md) priority fees.
...
These transactions support specifying [SIP-4844](./sip-4844.md) blobs.
...
These transactions support specifying an [SIP-7702](./sip-7702.md) authorization list.
...
def calculate_transaction_intrinsic_gas(tx: Transaction) -> uint:
    ...
    gas_cost = TX_BASE_COST # FIXME: Should this be defined from another SIP?
...
The [execution block header's `txs-root`](https://github.com/sila-chain/devp2p/blob/bc76b9809a30e6dc5c8dcda996273f0f9bcf7108/caps/sil.md#block-encoding-and-validity) is transitioned from MPT to SSZ.
...
In the engine API, the semantics of the `transactions` field in `ExecutionPayload` versions adopting this SIP are changed to emit transactions using SSZ serialization.
...
When building a consensus `ExecutionPayload`, the [`transactions`](https://github.com/sila-chain/consensus-specs/blob/b5c3b619887c7850a8c1d3540b471092be73ad84/specs/deneb/beacon-chain.md#executionpayload) list is no longer opaque and uses the new `Transaction` type, aligning the `transactions_root` across execution blocks and execution payloads.
...
While there is no on-chain commitment of the `tx_hash`, it is widely used in JSON-RPC and the [Sila Wire Protocol](https://github.com/sila-chain/devp2p/blob/bc76b9809a30e6dc5c8dcda996273f0f9bcf7108/caps/sil.md) to uniquely identify transactions. The conversion from RLP transactions to SSZ is lossless. The original RLP `sig_hash` and `tx_hash` can be recovered from the SSZ representation.
