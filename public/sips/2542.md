...
2. Stateless Sila  
 ...
 As long as the concept of 'gas limit' is part of the EVM, the author sees no reason proposed opcodes would conflict with Stateless Sila. Gas schedules are not exposed by this proposal.
...
3. Comparison with other controversial opcodes   
 ...
 This SIP neither encourages nor enables any bad security practices, and does not introduce any concepts that are new for EVM either.  
