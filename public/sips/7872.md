...
This SIP adds a flag to the block builder in order to allow them to include a client configured maximum amount of blobs. This is an execution layer only change.
