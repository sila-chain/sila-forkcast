...
This SIP does not constrain retention of block headers, bodies, or receipts; those are governed by history-expiry rules.
...
Reorgs shallower than `REORG_RETENTION_WINDOW` can be resolved locally. Reorgs deeper than the window are out of scope for this SIP; recovery may require fresh sync from a trusted checkpoint.
