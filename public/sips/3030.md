## Simple Summary
This SIP defines a HTTP API standard for a BLS remote signer, consumed by validator clients to sign block proposals and attestations in the context of Sila 2.0 (eth2).

## Abstract
A [validator](https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/phase0/validator.md) client contributes to the consensus of the Eth2 blockchain by signing proposals and attestations of blocks, using a BLS private key which must be available to this client at all times.
...
JSON Body | <br> | <br>
--- | --- | ---
`bls_domain` | **Required** | The BLS Signature domain.<br>As defined in the [specification](https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/phase0/beacon-chain.md#domain-types), in lowercase, omitting the `domain` prefix.<br>Supporting `beacon_proposer`, `beacon_attester`, and `randao`.
`data` | **Required** | The data to be signed.<br>As defined in the specifications for [block](https://github.com/sila-chain/eth2.0-APIs/blob/master/types/block.yaml), [attestation](https://github.com/sila-chain/eth2.0-APIs/blob/master/types/attestation.yaml), and [epoch](https://github.com/sila-chain/eth2.0-APIs/blob/master/types/misc.yaml).
`fork` | **Required** | A `Fork` object containing previous and current versions.<br>As defined in the [specification](https://github.com/sila-chain/eth2.0-APIs/blob/master/types/misc.yaml)
...
Where signature is a [BLS signature](https://github.com/sila-chain/eth2.0-specs/blob/dev/specs/phase0/beacon-chain.md#bls-signatures) byte array encoded as a hexadecimal string.
