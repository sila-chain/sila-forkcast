...
This SIP adds two new wallet-namespaced RPC endpoints, `wallet_getPermissions` and `wallet_requestPermissions`, providing a standard interface for requesting and checking permissions.
...
![Facebook Permissions](../assets/sip-2255/facebook_permissions.png)

![Log in With Apple](../assets/sip-2255/log_in_with_apple.jpeg)
...
![Sample prompt screenshot](../assets/sip-2255/permissions.png)
...
If a `wallet_requestPermissions` request is rejected, it should throw an error with a `code` value equal to `4001` as per [SIP-1193](./sip-1193.md).
