...
To this end, the underlying uint256 lib can be wrapped with gas accumulation, as found in the reference implementation in ../assets/sip-EVM+/uint256_wrapped.go. This gives a bottom-up approach to calculating gas, by running the OPCODE.
...
This gives an embedded gas calculation, which works well for complex OPCODEs (see gasEVMPlusEmulate in ../assets/sip-EVM+/gasEVMPlusEmulate.go).
...
../assets/sip-EVM+/decimal_float_test.go

## Reference Implementation

The reference implementation is found in ../assets/sip-EVM+/decimal_float.go
