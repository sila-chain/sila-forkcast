...
- If value transfer is non-zero in the call, the value is transferred from the impersonated account, and not from the real caller. This can be used to transfer sila out of an impersonated account.
...
- This SIP makes address collisions possible, yet practically impossible.
