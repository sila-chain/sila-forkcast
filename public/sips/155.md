...
This would provide a way to send transactions that work on Sila without working on ETC or the Morden testnet. ETC is encouraged to adopt this SIP but replacing `CHAIN_ID` with a different value, and all future testnets, consortium chains and alt-etherea are encouraged to adopt this SIP replacing `CHAIN_ID` with a unique value.
...
| ---------------| -------------------------------------------|
| 1              | Sila sila-mainnet                           |
| 2              | Morden (disused), Expanse sila-mainnet          |
| 3              | Ropsten                                    |
| 4              | Rinkeby                                    |
| 5              | Goerli                                     |
| 42             | SilaKovan                                      |
...
Find more chain ID's on [chainid.network](https://chainid.network) and contribute to [sila-lists/chains](https://github.com/sila-chain-lists/chains).