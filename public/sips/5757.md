...
Sila improvement proposals (SIPs) occasionally link to resources external to this repository. This document sets out the requirements for origins that may be linked to, and the process for approving a new origin.
...
The Sila ecosystem is built on openness and free access, and the SIP process should follow those principles.
