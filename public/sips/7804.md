...
[SIP-7685](./sip-7685.md), decreasing the complexity of adding
...
| Name | Value | Comment |
| - | - | - |
|`FORK_TIMESTAMP` | *TBD* | SilaMainnet |
...
| `WITHDRAWAL_CREDENTIALS_UPDATE_REQUEST_TYPE` | `0x03` | The [SIP-7685](./sip-7685.md) type prefix for withdrawal credential update request |
...
The new withdrawal credential update request operation is an [SIP-7685](./sip-7685.md) request
...
The [SIP-7685](./sip-7685.md) encoding of a withdrawal credential update request is computed as follows.
